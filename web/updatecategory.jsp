...
<html>
    ...
    <body>
            ...
            <header class="admin-header-bar">
                <div class="admin-header-content">
                    ...
                    <div class="header-content-box">
                        <a href="/mido/admin" class="header-content-text">
                            Kênh Admin
                        </a>
                    </div>
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li id="category" class="sidebar-menu-box">
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li class="sidebar-submenu-item">
                                        <a style="color: #e84f20;" href="/mido/admin/updatecategory" class="sidebar-submenu-item-link">
                                            <span>
                                                Sửa Danh Mục
                                            </span>
                                        </a>
                        ...
                        <div class="product-info">
                            ...
                            <form id="category-form" method="post" enctype = "multipart/form-data">
                                <div class="product-edit product-name-edit">
                                    <label class="label-product" style="width: 150px;">
                                        Tên danh mục cần đổi:
                                    </label>
                                    <div class="input-wrap">
                                        <select name="old-category" class="select-category" autocomplete="false">
                                ...
                                <div class="product-edit product-image-edit">
                                    ...
                                    <input class="input-image" type="file" name="file">
                                </div>
        ...
        <script>
            ...
            categories[${loop.index}] = '${category.getName().toLowerCase()}';
            </c:forEach>
            ...
            document.getElementById('category-form').onsubmit = (e) => {
                if (document.getElementsByName('name')[0].value === '') {
                    ...
                    e.preventDefault();
                } else if (categories.includes(document.getElementsByName('name')[0].value.trim().toLowerCase())) {
                    document.getElementsByClassName('product-edit-form-item-error')[0].style.display = 'block';
                    document.getElementsByClassName('product-edit-form-item-error')[0].innerHTML = 'Danh mục này đã tồn tại';
                    e.preventDefault();
                } else
                    document.getElementsByClassName('product-edit-form-item-error')[0].style.display = 'none';
            };
