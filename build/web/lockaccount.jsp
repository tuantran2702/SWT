    ...
    <body>
                    ...
                    <div class="sidebar">
                        <ul class="sidebar-menu">
                            ...
                            <li id="user" class="sidebar-menu-box">
                                ...
                                <ul class="sidebar-submenu">
                                    <li class="sidebar-submenu-item">
                                        <a style="color: #e84f20;" href="/mido/admin/lockaccount" class="sidebar-submenu-item-link">
                                            <span>
                                                Khóa Tài Khoản
                                            </span>
                                        </a>
        ...
        <script>
            ...
            <c:if test="${active != null}">
                document.getElementsByClassName('product-edit-form-item-error')[0].style.display = 'block';
                document.getElementsByClassName('product-edit-form-item-error')[0].innerHTML = 'Tài khoản đã khóa từ trước';
            </c:if>
                
            <c:if test="${admin != null}">
                document.getElementsByClassName('product-edit-form-item-error')[0].style.display = 'block';
                document.getElementsByClassName('product-edit-form-item-error')[0].innerHTML = 'Không được khóa tài khoản admin';
            </c:if>
