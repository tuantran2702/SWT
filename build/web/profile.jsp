                    ...
                    <div class="body-main__form-wrapper">
                        <div style="padding: 0 1.875rem .625rem;">
                            <div class="form-header">
                                <h1 class="form-header__title">Hồ sơ của tôi</h1>
                                <div class="form-header__desc">Quản lý thông tin hồ sơ để bảo mật tài khoản</div>
                            </div>
                            ...
                            <div class="form-body">
                                    ...
                                    <form id="form" action="profile" method="post" enctype = "multipart/form-data">
                                        <div class="form-item-wrapper">
                                            <div class="form-item">
                                                ...
                                                <div class="form-item__input">
                                                    <div class="form-item__input-not-type">${cookie.username.value}</div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div style="width:100%">
                                                        ...
                                                        <div class="notify-bellow">
                                                            <c:if test="${email!=null}">
                                                                Email ${email} đã được người dùng khác sử dụng
                                                            </c:if>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-item-wrapper">
                                            <div class="form-item">
                                                ...
                                                <div class="form-item__input">
                                                    <input type="radio" name="gender" value="1" ${user.getGender() == 1 ? "checked" : ""}>
                                                    <label for="gender">Nam</label><br>
                                                    <input type="radio" name="gender" value="2" ${user.getGender() == 2 ? "checked" : ""}>
                                                    <label for="gender">Nữ</label><br>
                                                    <input type="radio" name="gender" value="3" ${user.getGender() == 3 ? "checked" : ""}>
                                ...
                                <!--                                <div class="form-body__upload-img">
