                                            ...
                                            <div class="product-basic-info">
                                                <div class="container">
                                                        ...
                                                        <div class="edit-input">
                                                            <div class="popover-wrap">
                                                                <div class="mido-input__inner ">
                                                                    <input name="product_name" type="text" placeholder="Nhập vào" size="large" resize="none" rows="2" minrows="2" maxlength="Infinity" restrictiontype="input" max="Infinity" min="-Infinity" class="mido-input__input">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="popover-wrap">
                                                                <div class="mido-input__area">
                                                                    <textarea name="product_desc" type="textarea" resize="none" rows="2" minrows="9" maxrows="26" autosize="true" 
                                                                              maxlength="Infinity" restrictiontype="input" max="Infinity" min="-Infinity" 
                                                    ...
                                                    <div class="product-basic-info__item">
                                                        ...
                                                        <div class="edit-input">
                                                            <div class="popover-wrap">
                                                                <select name="category" class="select-category" autocomplete="false">
                                                ...
                                                <div class="container">
                                                    <div class="product-basic-info__item">
                                                        ...
                                                        <div class="edit-input">
                                                            <div class="popover-wrap">
                                                                <div class="mido-input__inner ">
                                                                    <input name="brand" type="text" placeholder="Nhập vào" size="large" resize="none" rows="2" minrows="2" maxlength="Infinity" restrictiontype="input" max="Infinity" min="-Infinity" class="mido-input__input">
                                                                </div>
                                                            </div>
                                                            <div class="product-edit-form-item-error">Không được để trống ô</div>
                                                        </div>
                                            ...
                                            <div class="product-sales-info">
                                                                        ...
                                                                        <div class="edit-text">
                                                                            <div class="popover-wrap">
                                                                                <div class="mido-input">
                                                                                    <div class="mido-input__inner">
                                                                                        <input name="subgroup_name1" type="text" placeholder="Nhập tên Nhóm phân loại hàng, ví dụ: màu sắc, kích thước v.v" size="large" 
                                                                    ...
                                                                    <div style="margin-top: 32px;" class="options-panel__item">
                                                                        ...
                                                                        <div class="edit-text">
                                                                            <div class="popover-wrap">
                                                                                <div class="mido-input">
                                                                                    <div class="mido-input__inner">
                                                                                        <input type="text" name="subgroup_value1" placeholder="Nhập phân loại hàng, ví dụ: Trắng, Đỏ v.v" size="large" 
                                                                                               resize="none" rows="2" minrows="2" maxlength="Infinity" restrictiontype="input" 
                                                                                               max="Infinity" min="-Infinity" class="mido-input__input">
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="options-panel__item">
                                                                        ...
                                                                        <div class="edit-text">
                                                                            <div class="popover-wrap">
                                                                                <div class="mido-input">
                                                                                    <div class="mido-input__inner">
                                                                                        <input name="subgroup_name2" type="text" placeholder="Nhập tên phân loại, ví dụ: Size, v.v" size="large" 
                                                                                               resize="none" rows="2" minrows="2" maxlength="Infinity" restrictiontype="input" 
                                                                                               max="Infinity" min="-Infinity" class="mido-input__input">
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <div class="product-basic-info__item">
                                                    ...
                                                    <div class="edit-input">
                                                        <div class="popover-wrap">
                                                            <div class="mido-input__inner ">
                                                                <input name="quantity" type="text" placeholder="Nhập vào" size="large" resize="none" rows="2" minrows="2" maxlength="Infinity" restrictiontype="input" max="Infinity" min="-Infinity" class="mido-input__input">
                                                            </div>
                                                        </div>
                                                        <div class="product-edit-form-item-error">Không được để trống ô</div>
                                                    </div>
                                                ...
                                                <div class="product-basic-info__item">
                                                    ...
                                                    <div class="edit-input" style="
                                                        ...
                                                        <div class="popover-wrap">
                                                            <div class="mido-input__inner ">
                                                                <input id="price" name="price" type="text" placeholder="Nhập vào" size="large" resize="none" rows="2" minrows="2" maxlength="Infinity" restrictiontype="input" max="Infinity" min="-Infinity" class="mido-input__input">
                                                            </div>
                                                        </div>
                                                        <div class="product-edit-form-item-error">Không được để trống ô</div>
                                                    </div>
