    ...
    <body>
        <div id="main">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li id="product" class="sidebar-menu-box">
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li class="sidebar-submenu-item">
                                        <a  style="color: #e84f20;" href="/mido/admin/updateproduct?type=1" class="sidebar-submenu-item-link">
                                            <span>
                                                Sửa Sản Phẩm
                                            </span>
                                        </a>
                    ...
                    <div class="admin-page-content-wrapper">
                        <div class="product-info">
                            <div class="product-info__header">
                                <h2 class="title">
                                    <c:if test="${param.type == 1}">Sửa sản phẩm</c:if>
                                    <c:if test="${param.type == 2}">Xóa sản phẩm</c:if>
                                ...
                                <form id="user-form" <c:if test="${param.type == 1}">method="get"</c:if> <c:if test="${param.type == 2}">method="post"</c:if>>
                                ...
                                <div class="product-edit product-name-edit">
                                    ...
                                    <div class="input-wrap">
                                        <div class="input-wrap__inner">
                                            <input name="id" type="text" placeholder="Nhập vào" size="large" resize="none" rows="2" minrows="2" maxlength="Infinity" 
                                                   restrictiontype="input" max="Infinity" min="-Infinity" class="mido-input__input" value="${id}${productid}">
                                        </div>
                                ...
                                <div class="flex items-center">
                                    <button type="submit" class="product-button" style="width: 115px;">
                                        <span>
                                            <c:if test="${param.type == 1}">Tiếp</c:if>
                                            <c:if test="${param.type == 2}">Xóa</c:if>
                                            </span>
                                        </button>
                                    </div>
                                </form>
            ...
            <c:if test="${id != null}">
                ...
                document.getElementsByClassName('product-edit-form-item-error')[0].innerHTML = 'Không tồn tại sản phẩm';
            </c:if>
                
            <c:if test="${productid != null}">
                document.getElementsByClassName('product-edit-form-item-error')[0].style.display = 'block';
                document.getElementsByClassName('product-edit-form-item-error')[0].innerHTML = 'Không thể xóa sản phẩm trong đơn hàng';
            </c:if>
